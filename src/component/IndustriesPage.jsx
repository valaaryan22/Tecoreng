...
const IndustriesPage = () => {
    return (
        <div className="bg-[#01132E] " > {/* Dark background color and minimum screen height */}
            <div className="container mx-auto px-4  py-6 sm:py-16"> {/* Container with padding and centering */}
