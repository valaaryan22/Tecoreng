...
const Specialization = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-start ml-5 justify-start w-full pt-2 sm:py-16 pr-5 md:px-4 " style={{ backgroundColor: '#01132E' }}>
        {/* Header Section */}
        ...
        {visibleCards.map((service, index) => {
          ...
          return (
            <div
              ...
              style={{
                transform: `translateX(${(index - 1) * 180}px) translateY(-10%) ${index === 1 ? 'scale(1.4)' : 'scale(0.8)'}`, // Position and scale cards differently
              }}
            >
              ...
              {/* Title below icon */}
              <h2 className=" text-xs sm:text-sm font-bold text-left sm:text-center mb-4 text-black">{service.title}</h2>
