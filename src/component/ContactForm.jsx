    ...
    <span>+91 85117 46476</span>
                ...
                <div className="lg:w-1/2 bg-gray-100 p-6 rounded-3xl shadow-lg relative -mt-2 -ml-2">
                    <h3 className="text-5xl font-semibold mb-4">
                        ...
                        <span className="bg-gradient-to-r from-orange-500 to-orange-300 text-transparent bg-clip-text">Touch</span>
                    </h3>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6 flex space-x-2">
                            <select
                                className="w-1/3 py-2 border-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-500"
                                defaultValue="IN"
                            >
