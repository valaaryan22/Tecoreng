...
const Navbar = () => {
    ...
    >
        ...
        >
            ...
            <ul
                className={`nav-links md:hidden flex flex-col items-center gap-3 px-6 py-4 bg-[#001f3d] shadow-lg ${
        ...
        <div
            ...
            style={{
                ...
                backgroundSize: "contain", // Adjusting to "contain" for proper scaling
                backgroundPosition: "right center", // Adjust positioning
                backgroundRepeat: "no-repeat",
                transform: "scale(1.05)", // Increase the image size by 10%
                transition: "transform 0.3s ease-in-out", // Smooth transition
                 // Ensures it stays in place on scroll
            }}
        >
            <div className="w-full md:w-1/2 md:top-2 pt-20">
            ...
            <div className="hidden md:block absolute right-0 top-1/2 transform -translate-y-1/2 w-1/2">
               ...
               <div className="relative z-10 mb-3 border-2 rounded-3xl md:mt-0 md:pt-0 border-cyan-400 max-w-6xl mx-auto mt-16 px-4">
