...
const Navbar = () => {
    ...
    return (
        <div
            className="App min-h-screen flex flex-col bg-[#0a0a23] text-white overflow-x-hidden"
            style={{
        ...
        >
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a23] text-white shadow-md">
                <nav className="navbar flex items-center justify-between px-6 py-4">
                    ...
                    <div className="nav-buttons hidden md:flex gap-4">
                        <button className="hire-developers px-4 py-2 bg-[#1a1a40] text-white rounded-md hover:bg-orange-500">
                            Hire Developers
                        </button>
                        <button className="get-quote px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-700">
                            Get a Quote
                        </button>
                    </div>
                </nav>
                ...
                <ul
                    className={`nav-links md:hidden flex flex-col items-start gap-3 px-6 py-4 bg-[#0a0a23] shadow-lg ${menuOpen ? 'block' : 'hidden'
                        }`}
                >
                    ...
                    <div className="flex flex-col gap-4 w-full mt-4">
                        <button className="hire-developers w-full px-4 py-2 bg-[#1a1a40] text-white rounded-md hover:bg-orange-500">
                            Hire Developers
                        </button>
                        <button className="get-quote w-full px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-700">
                            Get a Quote
                        </button>
                    </div>
                </ul>
